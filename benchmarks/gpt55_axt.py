"""Run a knows_* benchmark with GPT-5.5 using the accessibility tree only.
...
from agentlab.agents.generic_agent import AGENT_GPT55_AXT


if __name__ == "__main__":
    run_knows_benchmark(AGENT_GPT55_AXT)
